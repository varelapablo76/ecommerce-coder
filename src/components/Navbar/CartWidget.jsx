...
const CartWidget = () => {
    ...
    const {listaCarrito, deleItemCart,emptyCart,valorTotal}  = UsoCarritoContext()
    ...
    return (
        ...
        <div className='d-flex flex-column align-items-end container'>
            ...
            <div key={prod.id} className='d-flex align-items-center justify-content-around py-3 '>
                
                <img className="product__content_imgCart col-md-3" src={prod.img} alt="" />
                <div className="product__content col-md-7 d-flex justify-content-between ">
                    <div className="product__content_info  ms-2">
                        ...
                        <p className="product__content_title"> Cantidad: {prod.cantidad}</p>
                        </div>
                        <div>
                ...
                <div className="d-flex align-items-center">
                 ...
                 <Button onClick={()=>deleItemCart(prod.id)} variant="outline-secondary" className='m-2'>   <FiTrash /> </Button>
